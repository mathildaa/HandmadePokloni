	...
	<div class="page">
		<div class="header">
			<div class="header-menu">
				...
				<b>U ovoj sekciji možete dodati novost na stranicu, popunite formu:</b>
				</ul>
			</div>
		</div>
		<div class="cover">
			...
			<div class="main">
				<div class="div-news">
					<div class="news">	
							<form id="unosForma" id = "forma" method="post">					
									...
									<tbody>
										...
										<tr> 
											<td>Odaberite zemlju<td>
												...
												<select name="zemlja" rows = "12" align = "right">
										...
										<tr> 
											<td>Broj telefona</td>
											<td><input autofocus type = "text" size = "24" name = "telefon" onkeyup = "telefonValidacija(this)"></td>
